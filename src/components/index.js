      ...
      <Grid container spacing={24} style={props.theme.container}>
        <Grid item xs={12}>
          <Typography variant="body1" gutterBottom>
            ...
            and maintaining software and user interfaces for a multitude of
            platforms and devices including web based applications as well as
            native apps for Windows, Android, iOS, Google Cardboard, GearVR and
            more. The projects listed in my portfolio range from interactive
            video games and entertainment applications to business and
            utilities.
          </Typography>
          <Typography variant="body1" gutterBottom>
